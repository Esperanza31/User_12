...
class CLEAfternoon extends amplify_core.Model {
  ...
  CLEAfternoonModelIdentifier get modelIdentifier {
      return CLEAfternoonModelIdentifier(
        id: id
      );
  }
  ...
  const CLEAfternoon._internal({required this.id, required BusStop, required TripNo, required Count, createdAt, updatedAt}): _BusStop = BusStop, _TripNo = TripNo, _Count = Count, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CLEAfternoon({String? id, required String BusStop, required int TripNo, required int Count}) {
  ...
  static final amplify_core.QueryModelIdentifier<CLEAfternoonModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<CLEAfternoonModelIdentifier>();
 ...
 */
class CLEAfternoonModelIdentifier implements amplify_core.ModelIdentifier<CLEAfternoon> {
  final String id;

  /** Create an instance of CLEAfternoonModelIdentifier using [id] the primary key. */
  const CLEAfternoonModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is CLEAfternoonModelIdentifier &&
      id == other.id;
  }
